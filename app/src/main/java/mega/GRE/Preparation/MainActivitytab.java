...
public class MainActivitytab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SELECT ACCORDING TO CHOICE");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent num2=new Intent(MainActivitytab.this,Settings.class);
            startActivity(num2);
            return true;
        }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    Tab1verbal tab1=new Tab1verbal();



                    return tab1;
                case 1:
                    Tab2quant tab2=new Tab2quant();

                    return tab2;
                case 2:
                    Tab3quiz tab3=new Tab3quiz();
