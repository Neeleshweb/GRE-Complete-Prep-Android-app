...
public class Rcset1seven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rcset1seven);
        rg=(RadioGroup)findViewById(R.id.rgs7);
        tv1=(TextView)findViewById(R.id.textView46);
        tv2=(TextView)findViewById(R.id.textView47);



        btn=(Button)findViewById(R.id.butt7);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radio31:
                        ...
                        get = getIntent();
                        a = get.getIntExtra("val6", 0);
                        b = num.calculatescore1(value);
                        sum = a + b;


                        Intent send = new Intent(Rcset1seven.this, Rcset1eight.class);
                    ...
                    case R.id.radio32:
                        ...
                        Intent send1 = new Intent(Rcset1seven.this, Rcset1eight.class);
                    ...
                    case R.id.radio33:
                        ...
                        Intent send2 = new Intent(Rcset1seven.this, Rcset1eight.class);
                    ...
                    case R.id.radio34:
                        ...
                        Intent send8 = new Intent(Rcset1seven.this, Rcset1eight.class);
                    ...
                    case R.id.radio35:
                        ...
                        Intent fuck = new Intent(Rcset1seven.this, Rcset1eight.class);
                        fuck.putExtra("val7", sum);
                        startActivity(fuck);
                        finish();
                        break;
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(R.id.radio31==checkedId) {
                    value4=0;



                }
                else if(R.id.radio32==checkedId) {
                    value=1;

                }
                else if(R.id.radio33==checkedId) {
                    value1=0;

                }
                else if(R.id.radio34==checkedId) {
                    value3=0;


                }
                else if(R.id.radio35==checkedId) {
                    value2=0;
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Rcset1seven.this);
        make.setTitle("SORRY !!");
