...
public class Rcset1eight extends AppCompatActivity {
    RadioGroup rg;
    TextView tv1,tv2;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rcset1eight);
        rg=(RadioGroup)findViewById(R.id.rgs8);
        tv1=(TextView)findViewById(R.id.textView48);
        tv2=(TextView)findViewById(R.id.textView49);



        btn=(Button)findViewById(R.id.butt8);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radio36:
                        ...
                        Intent send = new Intent(Rcset1eight.this, Rcset1nine.class);
                    ...
                    case R.id.radio37:
                        ...
                        Intent send1 = new Intent(Rcset1eight.this, Rcset1nine.class);
                        send1.putExtra("val8", sum);
                        startActivity(send1);
                        finish();
                        break;
                    case R.id.radio38:
                        ...
                        Intent send2 = new Intent(Rcset1eight.this, Rcset1nine.class);
                    ...
                    case R.id.radio39:
                        ...
                        Intent send8 = new Intent(Rcset1eight.this, Rcset1nine.class);
                        send8.putExtra("val8", sum);
                        startActivity(send8);
                        finish();
                        break;
                    ...
                    case R.id.radio40:
                        ...
                        Intent fuck = new Intent(Rcset1eight.this, Rcset1nine.class);
                        fuck.putExtra("val8", sum);
                        startActivity(fuck);
                        finish();
                        break;
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(R.id.radio36==checkedId) {
                    value4=0;



                }
                else if(R.id.radio37==checkedId) {
                    value3=0;

                }
                else if(R.id.radio38==checkedId) {
                    value1=0;

                }
                else if(R.id.radio39==checkedId) {
                    value=1;


                }
                else if(R.id.radio40==checkedId) {
                    value2=0;
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Rcset1eight.this);
        make.setTitle("SORRY !!");
