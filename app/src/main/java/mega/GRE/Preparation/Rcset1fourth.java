...
public class Rcset1fourth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rcset1fourth);
        rg=(RadioGroup)findViewById(R.id.rgs4);
        tv1=(TextView)findViewById(R.id.textView40);
        tv2=(TextView)findViewById(R.id.textView41);



        btn=(Button)findViewById(R.id.butt4);
            ...
            public void onClick(View v) {
                ...
                switch (ids) {
                    case R.id.radio16:
                        ...
                        Intent send = new Intent(Rcset1fourth.this, Rcset1fifth.class);
                    ...
                    case R.id.radio17:
                        ...
                        Intent send1 = new Intent(Rcset1fourth.this, Rcset1fifth.class);
                    ...
                    case R.id.radio18:
                        ...
                        Intent send2 = new Intent(Rcset1fourth.this, Rcset1fifth.class);
                    ...
                    case R.id.radio19:
                        ...
                        Intent send8 = new Intent(Rcset1fourth.this, Rcset1fifth.class);
                    ...
                    case R.id.radio20:
                        ...
                        Intent fuck = new Intent(Rcset1fourth.this, Rcset1fifth.class);
                        fuck.putExtra("val4", sum);
                        startActivity(fuck);
                        finish();
                        break;
        ...
        rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(R.id.radio16==checkedId) {
                    value=1;



                }
                else if(R.id.radio17==checkedId) {
                    value1=0;

                }
                else if(R.id.radio18==checkedId) {
                    value4=0;

                }
                else if(R.id.radio19==checkedId) {
                    value3=0;


                }
                else if(R.id.radio20==checkedId) {
                    value2=0;
    ...
    protected void exitByBackKey() {
        ...
        AlertDialog.Builder make = new AlertDialog.Builder(Rcset1fourth.this);
        make.setTitle("SORRY !!");
